...
<script>
  ...
  export default {
    ...
    computed: {
      finished: {
        get () {
          return this.$store.getters['request/getListFinished']
        },
        set (value) {
          return this.$store.commit('request/SET_LIST_FINISHED', value)
        },
      },
    },
    methods: {
      ...
      async readDataFromAPI () {
        ...
        let data = await this.$store.dispatch('request/fetchListFinished', {
          page: page ? page : 1,
